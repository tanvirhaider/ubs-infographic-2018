...
var yearRightValue = [26, 36, 49, 56, 62, 67, 73, 77, 82, 87, 93, 100]; // @codekit-prepend "TweenMax.min.js"
...
function init() {
  ...
  var title_H1 = new Sprite({
    ...
    container: title.obj,
    text: {
      content: 'China’s Mobile Economy' // text: {content: '中国的移动经济'}
  ...
  var title_H2 = new Sprite({
    ...
    container: title.obj,
    text: {
      content: 'Total Internet users vs. mobile Internet users in China, in millions'
    }
  });
  var title_H3 = new Sprite({
    ...
    container: title.obj,
    text: {
      content: 'Source: https://cnnic.com.cn/IDR/ReportDownloads/201706/P020170608523740585924.pdf</br>*Forecast'
    }
  }); // module 1 -----------------------
  ...
  for (var i = 0; i < 12; i++) {
    ...
    TweenMax.fromTo(lineItemleftbg.obj, 1, {
      height: "0%"
    }, {
    ...
    TweenMax.fromTo(lineItemrightbg.obj, 1, {
      height: "0%"
    }, {
      ease: Power2.easeInOut,
      delay: i * 0.1,
  ...
  var mod2copy1 = new Sprite({
    ...
    container: mod2.obj,
    text: {
      content: 'Percentage of mobile Internet users making mobile payments'
    }
  });
  ...
  var mod2copy2 = new Sprite({
    ...
    container: mod2.obj,
    text: {
      content: 'Forecast of shoppers using their smartphones to pay at the point of sale by 2021'
    }
  });
  ...
  var m2b2_value = new Sprite({
    ...
    container: m2b2_bg.obj //   text: {content: '31%'}
  ...
  var mod3copy1 = new Sprite({
    ...
    container: mod3.obj,
    text: {
      content: 'Growth in total Chinese mobile payment transactions, in trillion RMB'
    }
  });
